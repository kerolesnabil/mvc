...
defined('DATABASE_PASSWORD')        ? null : define ('DATABASE_PASSWORD', 'keroles@1998');
...
defined('SESSION_SAVE_PATH')     ? null : define ('SESSION_SAVE_PATH', DS. APP_PATH. DS .'..'.DS. 'sessions')   ;

// SALT

defined('APP_SALT')     ? null : define ('APP_SALT', '$2a$07$yeMVCNwKEYopOhv0TWWRep$');
